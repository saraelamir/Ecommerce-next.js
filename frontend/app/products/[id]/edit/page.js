  ...
  if (success) return (
    <div className="container py-5">
      <div className="text-center card p-5" style={{ maxWidth: 500, margin: '0 auto', borderRadius: 20 }}>
        ...
        <h4 className="fw-bold mb-2">Product Updated!</h4>
        <div className="d-flex gap-3 justify-content-center">
          <button onClick={() => router.push('/seller/products')} className="btn" style={{ background: '#0d9488', color: '#fff', borderRadius: 10 }}>My Products</button>
          <button onClick={() => router.push(`/products/${id}`)} className="btn btn-outline-secondary" style={{ borderRadius: 10 }}>View Product</button>
        </div>
      </div>
    </div>
  );
      ...
      <div className="row justify-content-center">
        <div className="col-lg-7">
          <div className="d-flex align-items-center gap-3 mb-4">
            ...
            <h3 className="fw-bold mb-0"><i className="fas fa-edit me-2" style={{ color: '#0d9488' }}></i>Edit Product</h3>
          </div>
          ...
          <div className="card p-4" style={{ borderRadius: 20 }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="row g-3 mb-3">
                <div className="col-6">
                  ...
                  <div className="input-group">
                    ...
                    <input type="number" className="form-control" min="0" step="0.01" value={form.price}
                ...
                <div className="col-6">
                  ...
                  <input type="number" className="form-control" min="0" value={form.stockQuantity}
              ...
              <div className="d-flex gap-3">
                <button type="button" onClick={() => router.back()} className="btn btn-outline-secondary flex-fill" style={{ borderRadius: 10 }}>Cancel</button>
                <button type="submit" className="btn flex-fill" style={{ background: '#0d9488', color: '#fff', borderRadius: 10, fontWeight: 600 }} disabled={submitting}>
                  {submitting ? <><i className="fas fa-spinner fa-spin me-2"></i>Saving...</> : <><i className="fas fa-save me-2"></i>Save Changes</>}
                </button>
              </div>
            </form>
          </div>
